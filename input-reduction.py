...
#2. 加载LSTM模型
original_model = textattack.models.helpers.lstm_for_classification.LSTMForClassification.from_pretrained("/home/boost/.cache/textattack/models_v2/classification/lstm/mr")
